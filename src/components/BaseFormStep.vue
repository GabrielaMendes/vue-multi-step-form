<script setup>
const props = defineProps(["isFirst", "isLast", "validate"]);
  ...
  <div class="h-full flex flex-col pt-10 pb-5 px-[15%]">
    ...
    <section class="flex justify-between mt-auto">
      ...
      <button
        ...
        @click="goNext"
        type="button"
        class="w-32 py-3 ml-auto bg-marine-blue text-white rounded-lg font-medium hover:bg-opacity-[0.85] focus-visible:outline-none focus-visible:bg-opacity-[0.85] focus-visible:ring-offset-2 focus-visible:ring-2 focus-visible:ring-marine-blue"
      >
        Next Step
      </button>
      <button
